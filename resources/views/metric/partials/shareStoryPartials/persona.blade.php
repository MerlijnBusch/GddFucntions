<div class="row" id="create_profile_story_form">
    ...
    <div class="col-md-8 col-lg-9 col-xl-10">
        ...
        <div class="row">
            ...
            <div class="col-sm-10 col-md-10 col-xl-11">
                <input type="range" min="1" max="100" value="50" class="custom-range" id="form_slider_story_age">
            </div>
        </div>
        {{--Wieght kg--}}
        <div class="row">
            ...
            <div class="col-sm-10 col-md-10 col-xl-11">
                <input type="range" min="0" max="200" value="90" class="custom-range" id="form_slider_story_weight">
            </div>
        </div>
        {{--Height--}}
        <div class="row">
            ...
            <div class="col-sm-10 col-md-10 col-xl-11">
                <input type="range" min="1" max="250" value="180" class="custom-range" id="form_slider_story_height">
            </div>
        </div>
