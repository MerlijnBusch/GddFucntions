...
@section('content_with_out_sidebar')
    ...
    <form id="form_persona_submit" method="post" action="{{route('moderator.persona.store')}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="persona_title_form" name="persona_title_form" value="{{$story->title}}" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Story:</label>
            <div class="col-sm-10">
                <textarea class="form-control" id="persona_body_form" name="persona_body_form" rows="8" required>{{$story->description}}</textarea>
            </div>
        </div>
        <input type="hidden" name="json_data_bar_charts" id="json_data_bar_charts">
        <div id="persona_chart" class="masonry-layout">
...
@section('js')
    ...
    <script>
        ...
        const chart = function createBarChart(ArrayData){
            ...
            let html =
                "<div class=\"grid\">" +
                "    <div class=\"grid-item\"><div class=\"container-barchart horizontal flat\">" +
